...
![изображение 3.11](images/3.11.png)
...
![изображение 3.12](images/3.12.png)
...
![изображение 3.13](images/3.13.png)
...
![изображение 3.14](images/3.14.png)
...
![изображение 3.15](images/3.15.png)
...
![изображение 3.16](images/3.16.png)

17. И вот настал момент расширения raid-массива `mdadm --grow /dev/md127 --size=max`, просматриваю при помощи `lsblk -o`:

![изображение 3.17](images/3.17.png)

Хотя я и изменила размер raid, сами размеры vg root, log, var не изменились. При помощи команды `pvs` смотрю чему равен PV, расширяю его размер `pvresize /dev/md127` и вновь при помощи `pvs` смотрю чему равен размер PV:

![изображение 3.18](images/3.18.png)
...
![изображение 3.19](images/3.19.png)
...
![изображение 3.20](images/3.20.png)
...
![изображение 3.21](images/3.21.png)
